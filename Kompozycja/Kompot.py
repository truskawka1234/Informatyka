...
class Grabie:
    def __init__(self, nazwa, cena, waga, szerokosc):
        self.narzedzie = InformacjeONarzedziu(nazwa,cena,waga)
        self.szerokosc = szerokosc
    
    def wyswietl_informacje(self):
        print (self.narzedzie.wyswietl_informacje)
...
class Pracownik:
    def __init__(self, imie, nazwisko,dzial_pracy,konto,wyplata):
        self.osoba = Osoby(imie,nazwisko)
        self.dzial_pracy = dzial_pracy
        self.konto = konto
        self.wyplata = wyplata

    def info(self):
        return f'{kolory.jasny_zielony}{kolory.pogrubienie}{self.dzial_pracy}{kolory.reset} na tym dziale pracuje:{kolory.Magenta} {self.osoba.imie} {self.osoba.nazwisko}{kolory.reset}'
...
class Klient:
    ...
    def dane(self):
        print(f'\nnazwyasz się {self.osoba.imie}{self.osoba.nazwisko} masz na koncie: {self.saldo}zł')
...
# ---------------------------------------------------------------------------------------------------------
    ...
    def kup_kosiarki(self):                                                 
        if self.saldo >= kosiarka1.narzedzie.cena:                                    
            self.saldo -= kosiarka1.narzedzie.cena                                    
            print("Zakupiono produkt.")                                     
            print(f"Stan konta po zakupie: {self.saldo} zł")                
        elif self.saldo < kosiarka1.narzedzie.cena:                                   
            print("Nie masz wystarczająco pieniędzy na koncie.")            
                                                                            
                                                                            
    def kup_szpadel(self):                                                  
        if self.saldo >= szpadel1.narzedzie.cena:                                     
            self.saldo -= szpadel1.narzedzie.cena                                     
            print("Zakupiono produkt.")                                     
            print(f"Stan konta po zakupie: {self.saldo} zł")                
        elif self.saldo < szpadel1.narzedzie.cena:                                    
            print("Nie masz wystarczająco pieniędzy na koncie.")            
                                                                            
                                                                            
    def kup_sekator(self):                                                  
        if self.saldo >= sekator1.narzedzie.cena:                                     
            self.saldo -= sekator1.narzedzie.cena                                     
            print("Zakupiono produkt.")                                     
            print(f"Stan konta po zakupie: {self.saldo} zł")                                        
        elif self.saldo < sekator1.narzedzie.cena:                                        
            print("Nie masz wystarczająco pieniędzy na koncie.")                                        
                                                                            
    def kup_grabie(self):                                                   
        if self.saldo >= grabie1.narzedzie.cena:                                      
            self.saldo -= grabie1.narzedzie.cena                                      
            print("Zakupiono produkt.")                                     
            print(f"Stan konta po zakupie: {self.saldo} zł")                
        elif self.saldo < grabie1.narzedzie.cena:                                     
            print("Nie masz wystarczająco pieniędzy na koncie.")            
